...
def _get_merged_dataset(
    ...
    data_args: "DataArguments",
    training_args: "Seq2SeqTrainingArguments",
    stage: Literal["pt", "sft", "rm", "ppo", "kto", "attn_sft", "ppl", "bepo", "beft"],
    ...
    for dataset_name, dataset_attr in zip(dataset_names, get_dataset_list(dataset_names, data_args.dataset_dir)):
        if (stage == "rm" and dataset_attr.ranking is False) or (
            stage != "rm" and dataset_attr.ranking is True and stage != "bepo"
        ):
...
def _get_dataset_processor(
    ...
    if stage == "pt":
        ...
        dataset_processor_class = PplContrastiveDatasetProcessor
    elif stage == "bepo":
        dataset_processor_class = BepoPairwiseDatasetProcessor
    elif stage == "beft":
        dataset_processor_class = BeftContrastiveDatasetProcessor
    else:
...
def _get_preprocessed_dataset(
    ...
    if training_args.should_log:
        try:
            ...
            # print("In _get_preprocessed_dataset, dataset:", dataset)
            # breakpoint()
