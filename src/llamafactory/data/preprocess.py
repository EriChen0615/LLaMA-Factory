...
from .processors.beft_contrastive import preprocess_beft_contrastive_dataset, print_beft_contrastive_dataset_example
...
def get_preprocess_and_print_func(
    ...
    if stage == "pt":
        ...
        preprocess_func = partial(
            preprocess_beft_contrastive_dataset,
            template=template,
            tokenizer=tokenizer,
            processor=processor,
            data_args=data_args,
        )
        print_function = partial(print_beft_contrastive_dataset_example, tokenizer=tokenizer)
    else:
